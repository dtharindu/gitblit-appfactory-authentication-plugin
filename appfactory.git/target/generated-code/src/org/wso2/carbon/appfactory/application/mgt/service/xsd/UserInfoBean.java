 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static UserInfoBean parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UserInfoBean object =
                new UserInfoBean();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UserInfoBean".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UserInfoBean)org.wso2.carbon.appfactory.application.mgt.service.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://service.mgt.application.appfactory.carbon.wso2.org/xsd","email").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://service.mgt.application.appfactory.carbon.wso2.org/xsd","firstName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://service.mgt.application.appfactory.carbon.wso2.org/xsd","lastName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://service.mgt.application.appfactory.carbon.wso2.org/xsd","userName").equals(reader.getName())){
