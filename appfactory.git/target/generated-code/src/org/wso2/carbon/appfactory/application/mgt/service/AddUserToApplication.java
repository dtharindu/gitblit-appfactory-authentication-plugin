 ...
 */
            ...
            /**
            *  AddUserToApplication bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddUserToApplication
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addUserToApplication",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addUserToApplication",
                ...
                if (localApplicationIdTracker){
                             ...
                             if (localRoles!=null) {
                                   ...
                                   for (int i = 0;i < localRoles.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://service.mgt.application.appfactory.carbon.wso2.org", "roles", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static AddUserToApplication parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddUserToApplication object =
                new AddUserToApplication();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addUserToApplication".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddUserToApplication)org.wso2.carbon.appfactory.application.mgt.service.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://service.mgt.application.appfactory.carbon.wso2.org","roles").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone3){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://service.mgt.application.appfactory.carbon.wso2.org","roles").equals(reader.getName())){
